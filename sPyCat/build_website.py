...
def add_param_col(obj_param,soup,data):
    ...
    if obj_param == 'ID':
        ...
        if (obj_param == 'M1') or (obj_param == 'PB'):
            ...
            status_colurs = {'BW': '#2ca02c', 'Candidate': 'RB'}
...
def make_new_page(obj_data):
    ...
    targ_coords = coordinates.SkyCoord([targ_coords_str], frame="icrs", unit=(u.hourangle, u.deg))
...
for i,temp_path in enumerate(json_list):
    ...
    table_fields = ['ID','RAJ','DECJ','PB','Apparent Mag','M1', 'Type']
